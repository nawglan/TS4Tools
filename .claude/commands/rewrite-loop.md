...
/ralph-wiggum:ralph-loop "## TS4Tools 100% Legacy Parity Loop
...
1. **CHECK PROGRESS**: List implemented vs unimplemented features from the queue above.
   ...
   If ALL Phase 1-4 features are implemented, skip to COMPLETION CHECK.
...
After each iteration, check if ALL Phase 1-4 features are implemented:
- Helper file parser
...
" --completion-promise "FULL_PARITY_COMPLETE" --max-iterations 30
