...
/// <summary>
/// Catalog Floor Trim (CFLT) resource.
/// Used for decorative trim around floor edges.
...
{
    /// <summary>
    /// Resource type ID for CFLT resources.
    /// </summary>
    public const uint TypeId = 0x84C23219;
    ...
    /// <summary>
    /// Creates a new CFLT resource by parsing data.
    /// </summary>
    /// <param name="key">The resource key.</param>
    /// <param name="data">The resource data.</param>
    public CfltResource(ResourceKey key, ReadOnlyMemory<byte> data)
        : base(key, data)
    {
    }
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// Source: CFLTResource.cs lines 115-126
    /// </remarks>
    ...
    /// <inheritdoc/>
    /// <remarks>
    /// Source: CFLTResource.cs lines 128-145
    /// </remarks>
