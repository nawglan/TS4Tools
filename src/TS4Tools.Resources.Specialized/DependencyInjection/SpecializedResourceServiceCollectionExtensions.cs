...
public static class SpecializedResourceServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddSpecializedResources(this IServiceCollection services)
    {
        ...
        services.AddTransient<INGMPHashMapResource>(provider =>
        {
            ...
            return Task.Run(async () => await factory.CreateResourceAsync(1, null, default).ConfigureAwait(false)).ConfigureAwait(false).GetAwaiter().GetResult();
        });
        ...
        services.AddTransient<ITuningResource>(provider =>
        {
            ...
            return Task.Run(async () => await factory.CreateTuningAsync("default", "configuration", 0, null, default).ConfigureAwait(false)).ConfigureAwait(false).GetAwaiter().GetResult();
        });
        ...
        services.AddTransient<INameMapResource>(provider =>
        {
            ...
            return Task.Run(async () => await factory.CreateNameMapAsync("default", "1.0", "general", false, default).ConfigureAwait(false)).ConfigureAwait(false).GetAwaiter().GetResult();
        });
        ...
        services.AddTransient<IBlendGeometryResource>(provider =>
        {
            ...
            return Task.Run(async () => await factory.CreateAsync("default_mesh", "1.0", default).ConfigureAwait(false)).ConfigureAwait(false).GetAwaiter().GetResult();
        });
        ...
        services.AddTransient<ITerrainGeometryResource>(provider =>
        {
            ...
            return Task.Run(async () => await factory.CreateAsync(256, 256, 1.0f, default).ConfigureAwait(false)).ConfigureAwait(false).GetAwaiter().GetResult();
        });
